...
Use `morse reader - compact.py` to also read the hidden morse. This python script is simply more compact in terms of the code. So compact in fact, that it only takes up three lines compared to the 57 lines in the `morse reader - verbose.py` python script.
